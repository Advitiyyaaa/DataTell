...
TEST_QUESTIONS = [
    ...
    (
        "What is the average review score for the 'bed_bath_table' category, and what happens to sellers in that category if their score is too low?",
        "BOTH",
        "BOTH-06: Avg review score by category + low score consequences",
    ),
    (
        "Find the seller with the most delayed orders in 2017, and explain the shipping policy's rules for extreme delays.",
        "BOTH",
        "BOTH-07: Seller with most delays + extreme delay policy",
    ),
    (
        "What is the total revenue generated by orders paid in 10 or more installments, and what is the policy regarding maximum payment installments?",
        "BOTH",
        "BOTH-08: Revenue from 10+ installments + installment policy",
    ),
    (
        "Which product category has the highest number of returned orders, and what is the standard return window for non-defective items?",
        "BOTH",
        "BOTH-09: Category with most returns + standard return policy",
    ),
    (
        "What is the total revenue for the top 3 sellers, and what are the seller performance guidelines?",
        "BOTH",
        "BOTH-10: Top 3 sellers revenue + seller performance guidelines",
    ),
    # ------------------------------------------------------------------
